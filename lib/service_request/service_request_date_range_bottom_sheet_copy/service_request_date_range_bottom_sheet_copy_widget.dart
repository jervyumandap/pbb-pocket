...
import 'service_request_date_range_bottom_sheet_copy_model.dart';
export 'service_request_date_range_bottom_sheet_copy_model.dart';

class ServiceRequestDateRangeBottomSheetCopyWidget extends StatefulWidget {
  const ServiceRequestDateRangeBottomSheetCopyWidget({
    super.key,
    String? title,
    String? message,
  ...
  @override
  State<ServiceRequestDateRangeBottomSheetCopyWidget> createState() =>
      _ServiceRequestDateRangeBottomSheetCopyWidgetState();
}

class _ServiceRequestDateRangeBottomSheetCopyWidgetState
    extends State<ServiceRequestDateRangeBottomSheetCopyWidget>
    with TickerProviderStateMixin {
  late ServiceRequestDateRangeBottomSheetCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(
        context, () => ServiceRequestDateRangeBottomSheetCopyModel());
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      wrapWithModel(
                                        model:
                                            _model.startDatePickerWidgetModel1,
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                      ...
                                      wrapWithModel(
                                        model: _model.endDatePickerWidgetModel1,
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: FilterDatePickerWidgetWidget(
                                          label: 'End Date',
                                  ...
                                  Expanded(
                                    child: Builder(
                                      builder: (context) => FFButtonWidget(
                                        onPressed: ((_model.fromDate == null) &&
                                                (_model.toDate == null))
                                            ? null
                                            : () async {
                                                _model.apiResultgtxw =
                                                ...
                                                if ((_model.apiResultgtxw
                                                        ?.succeeded ??
                                                    true)) {
                                                  await actions
                                                      .downloadInvestmentStatement(
                                                    getJsonField(
                                                      (_model.apiResultgtxw
                                                              ?.jsonBody ??
                                                          ''),
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      wrapWithModel(
                                        model:
                                            _model.startDatePickerWidgetModel2,
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: FilterDatePickerWidgetWidget(
                                          label: 'Start Date',
                                      ...
                                      wrapWithModel(
                                        model: _model.endDatePickerWidgetModel2,
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: FilterDatePickerWidgetWidget(
                                          label: 'End Date',
