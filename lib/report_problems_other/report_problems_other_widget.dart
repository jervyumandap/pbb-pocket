...
import 'report_problems_other_model.dart';
export 'report_problems_other_model.dart';

class ReportProblemsOtherWidget extends StatefulWidget {
  const ReportProblemsOtherWidget({super.key});

  static String routeName = 'reportProblemsOther';
  static String routePath = '/reportProblemsOther';

  @override
  State<ReportProblemsOtherWidget> createState() =>
      _ReportProblemsOtherWidgetState();
}

class _ReportProblemsOtherWidgetState extends State<ReportProblemsOtherWidget> {
  late ReportProblemsOtherModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportProblemsOtherModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await action_blocks.refreshSessionActionBlock(context);
      _model.isConcernNotValid = false;
      safeSetState(() {});
    });
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              'Please describe your concern below and our team will assist you.\n',
                                ...
                                child: Semantics(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if (_model.additionalDetailsTextController
                                              .text ==
                                          '') {
                                        _model.isConcernNotValid = true;
                                        safeSetState(() {});
                                      } else {
                                        _model.isConcernNotValid = false;
                                        safeSetState(() {});
