...
import '/pay_bills/p_b_components/edit_biller_component/edit_biller_component_widget.dart';
...
import 'pay_bill_page_model.dart';
export 'pay_bill_page_model.dart';

/// Money Transfer Form
class PayBillPageWidget extends StatefulWidget {
  ...
  static String routeName = 'PayBillPage';
  static String routePath = '/payBillPage';

  @override
  State<PayBillPageWidget> createState() => _PayBillPageWidgetState();
}

class _PayBillPageWidgetState extends State<PayBillPageWidget>
    with TickerProviderStateMixin {
  late PayBillPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PayBillPageModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await Future.wait([
        ...
        Future(() async {
          ...
          await _model.getSavedBillers(context);
          safeSetState(() {});
        }),
      ]);
    });
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            height:
                                                                                24.0,
                                                                            child:
                                                                                custom_widgets.CustomRadioButtonOnly(
                                                                              width: 24.0,
                                                                              height: 24.0,
                                ...
                                return Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Builder(
                                        builder: (context) {
                                          final favoriteBillerList =
                                              _model.savedBillerFav.toList();
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemCount:
                                                favoriteBillerList.length,
                                            itemBuilder: (context,
                                                favoriteBillerListIndex) {
                                              final favoriteBillerListItem =
                                                  favoriteBillerList[
                                                      favoriteBillerListIndex];
                                              return Column(
                                                mainAxisSize: MainAxisSize.max,
                                                  ...
                                                  Align(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      child:
                                                        ...
                                                        key: Key(
                                                            'Keyc1r_${favoriteBillerListIndex}_of_${favoriteBillerList.length}'),
                                                        userInitial: functions
                                                            .extractReceiver(
                                                                favoriteBillerListItem
                                                                    .accountHolderName),
                                                        userNickname:
                                                            favoriteBillerListItem
                                                                .nickname,
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      updateBiller:
                                                                        ...
                                                                        var confirmDialogResponse = await showDialog<bool>(
                                                                              ...
                                                                              builder: (alertDialogContext) {
                                                                                return WebViewAware(
                                                                                  child: AlertDialog(
                                                                                    title: Text('Edit Biller'),
                                                                                    content: Text('Are you sure you want to edit this biller?'),
                                                                                    actions: [
                                                                                      TextButton(
                                                                        ...
                                                                        if (confirmDialogResponse) {
                                                                          _model.updateBillersss = await WhitebankGroupAPIGroup
                                                                        ...
                                                                        if ((_model.updateBillersss?.succeeded ??
                                                                            true)) {
                                                                      ...
                                                                      deleteBillers:
                                                                        ...
                                                                        var confirmDialogResponse = await showDialog<bool>(
                                                                              ...
                                                                              builder: (alertDialogContext) {
                                                                                return WebViewAware(
                                                                                  child: AlertDialog(
                                                                                    ...
                                                                                    content: Text('You are now deleting this Biller?'),
                                                                                    actions: [
                                                                                      TextButton(
                                                                                        onPressed: () => Navigator.pop(alertDialogContext, false),
                                                                                        child: Text('Cancel'),
                                                                            ...
                                                                            false;
                                                                        if (confirmDialogResponse) {
                                                                          _model.apiResulthml = await WhitebankGroupAPIGroup
                                                                        ...
                                                                        if ((_model.apiResulthml?.succeeded ??
                                                                            true)) {
                                                                          await _model
                                                                              .getSavedBillers(context);
                                                                          Navigator.pop(
                                                                              context);
                                                                        }
                                                                      },
