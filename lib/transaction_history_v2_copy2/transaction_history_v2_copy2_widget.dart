...
import 'transaction_history_v2_copy2_model.dart';
export 'transaction_history_v2_copy2_model.dart';

class TransactionHistoryV2Copy2Widget extends StatefulWidget {
  const TransactionHistoryV2Copy2Widget({super.key});

  static String routeName = 'TransactionHistoryV2Copy2';
  static String routePath = '/transactionHistoryV2Copy2';

  @override
  State<TransactionHistoryV2Copy2Widget> createState() =>
      _TransactionHistoryV2Copy2WidgetState();
}

class _TransactionHistoryV2Copy2WidgetState
    extends State<TransactionHistoryV2Copy2Widget>
    with TickerProviderStateMixin {
  late TransactionHistoryV2Copy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransactionHistoryV2Copy2Model());
                                                            ...
                                                            itemBuilder: (context,
                                                              ...
                                                              return wrapWithModel(
                                                                ...
                                                                child:
                                                                  ...
                                                                  key: Key(
                                                                    'Keygt1_${recentTransactionsItem.id}',
                                                                  ),
                                                                  transaction:
                                                                      recentTransactionsItem,
                                                                  callback:
                          ...
                          builder: (context) => wrapWithModel(
                            ...
                            child: CustomWebAppBarWidget(
                                          ...
                                          child: DateRangeBottomSheetWidget(
                                            ...
                                            selectedFilter:
                                              ...
                                              if (_model
                                                ...
                                                _model.getTransferHistoryResponse =
                                                ...
                                                if ((_model.getBPHistoryResponse
                                                        ?.succeeded ??
                                                    true)) {
                                                  _model.billsPaymentHistory =
                                                      BillsPaymentHistoryModelStruct
                                                          .maybeFromMap((_model
                                                                  .getBPHistoryResponse
                                                                  ?.jsonBody ??
                                                              ''));
                                                  safeSetState(() {});
                                                }
                              ...
                              rightButtonAction: () async {
                                if (((_model.isFundTransferSelected
                                                ? _model
                                                    .transferHistoryModel?.items
                                                    .map((e) => e.toMap())
                                                    .toList()
                                                : _model.billsPaymentHistory
                                                    ?.payments
