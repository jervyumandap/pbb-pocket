...
import '/index.dart';
import 'transaction_history_v2_copy2_widget.dart'
    show TransactionHistoryV2Copy2Widget;
import 'package:flutter/material.dart';

class TransactionHistoryV2Copy2Model
    extends FlutterFlowModel<TransactionHistoryV2Copy2Widget> {
  ...
  // Stores action output result for [Backend Call - API (Retail Bills Payment History)] action in TransactionHistoryV2Copy2 widget.
  ApiCallResponse? apiResultfx8;
  // Stores action output result for [Backend Call - API (Get Transfer History)] action in TransactionHistoryV2Copy2 widget.
  ...
  // Stores action output result for [Backend Call - API (Retail Bills Payment History)] action in CustomWebAppBar widget.
  ApiCallResponse? getBPHistoryResponse;
  // Stores action output result for [Backend Call - API (Get Transfer History)] action in CustomWebAppBar widget.
  ApiCallResponse? getTransferHistoryResponse;
