...
import 'report_problems_loan_concern_model.dart';
export 'report_problems_loan_concern_model.dart';

class ReportProblemsLoanConcernWidget extends StatefulWidget {
  const ReportProblemsLoanConcernWidget({super.key});

  static String routeName = 'reportProblemsLoanConcern';
  static String routePath = '/reportProblemsLoanConcern';

  @override
  State<ReportProblemsLoanConcernWidget> createState() =>
      _ReportProblemsLoanConcernWidgetState();
}

class _ReportProblemsLoanConcernWidgetState
    extends State<ReportProblemsLoanConcernWidget> {
  late ReportProblemsLoanConcernModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportProblemsLoanConcernModel());
