...
import '/index.dart';
import 'report_problems_loan_concern_widget.dart'
    show ReportProblemsLoanConcernWidget;
import 'package:flutter/material.dart';

class ReportProblemsLoanConcernModel
    extends FlutterFlowModel<ReportProblemsLoanConcernWidget> {
  ///  Local state fields for this page.

  ReportLoanConcernSelectedStruct? informationSelected;
  void updateInformationSelectedStruct(
      Function(ReportLoanConcernSelectedStruct) updateFn) {
    updateFn(informationSelected ??= ReportLoanConcernSelectedStruct());
  }
