  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case AccountTypesRow:
            return AccountTypesRow(data);
          case LoanRepaymentScheduleRow:
            return LoanRepaymentScheduleRow(data);
          case UserSecurityRow:
            return UserSecurityRow(data);
          case LoanRepaymentStatusesRow:
            return LoanRepaymentStatusesRow(data);
          case BeneficiariesRow:
            return BeneficiariesRow(data);
          case UserRequestsRow:
            return UserRequestsRow(data);
          case TransferStatusesRow:
            return TransferStatusesRow(data);
          case UserSecurityFeaturesRow:
            return UserSecurityFeaturesRow(data);
          case LoansRow:
          ...
          case LoanStatusesRow:
            return LoanStatusesRow(data);
          case FavoriteTransfersRow:
            return FavoriteTransfersRow(data);
          case UserStatusesRow:
            return UserStatusesRow(data);
          case UserProfilesRow:
            return UserProfilesRow(data);
          case TransactionStatusesRow:
            return TransactionStatusesRow(data);
          case TransactionLimitsRow:
            return TransactionLimitsRow(data);
          case TransfersRow:
            return TransfersRow(data);
          case MessagesRow:
            return MessagesRow(data);
          case AccountStatusesRow:
            return AccountStatusesRow(data);
          case UsersRow:
            return UsersRow(data);
          case BillersRow:
            return BillersRow(data);
          case SecurityFeaturesRow:
            return SecurityFeaturesRow(data);
          case AlertsRow:
            return AlertsRow(data);
          case AuditLogsRow:
            return AuditLogsRow(data);
          case UserRequestStatusesRow:
            return UserRequestStatusesRow(data);
          default:
            return null;
        }
