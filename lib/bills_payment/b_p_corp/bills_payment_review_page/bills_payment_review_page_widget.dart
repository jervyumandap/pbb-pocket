...
import 'bills_payment_review_page_model.dart';
export 'bills_payment_review_page_model.dart';

class BillsPaymentReviewPageWidget extends StatefulWidget {
  const BillsPaymentReviewPageWidget({
    super.key,
    required this.billsHeader,
    required this.billsBody,
    required this.bpFieldsModel,
  });
  ...
  static String routeName = 'BillsPaymentReviewPage';
  static String routePath = '/billsPaymentReviewPage';

  @override
  State<BillsPaymentReviewPageWidget> createState() =>
      _BillsPaymentReviewPageWidgetState();
}

class _BillsPaymentReviewPageWidgetState
    extends State<BillsPaymentReviewPageWidget> with TickerProviderStateMixin {
  late BillsPaymentReviewPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BillsPaymentReviewPageModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.addToEmailAddresses(AddressesStruct(
        toAddress: currentUserData?.user.email,
      ));
      safeSetState(() {});
    });
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          child: Text(
                                            'Please review your transaction details below before clicking submit.',
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      flex: 3,
                                                      child: Text(
                                                        'After 3 occurences (Until 21-Jan-2026) ',
                                                        textAlign:
                                                            TextAlign.start,
                                                        style:
                                                            FlutterFlowTheme.of(
