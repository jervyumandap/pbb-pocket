...
import '/utilities/service_request/components/service_request_details_component/service_request_details_component_widget.dart';
...
import 'service_request_page_model.dart';
export 'service_request_page_model.dart';

class ServiceRequestPageWidget extends StatefulWidget {
  const ServiceRequestPageWidget({super.key});

  static String routeName = 'ServiceRequestPage';
  static String routePath = '/serviceRequestPage';

  @override
  State<ServiceRequestPageWidget> createState() =>
      _ServiceRequestPageWidgetState();
}

class _ServiceRequestPageWidgetState extends State<ServiceRequestPageWidget> {
  late ServiceRequestPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ServiceRequestPageModel());

    _model.textFieldSearchTextController ??= TextEditingController();
    _model.textFieldSearchFocusNode ??= FocusNode();

    _model.textFieldSearchWebTextController ??= TextEditingController();
    _model.textFieldSearchWebFocusNode ??= FocusNode();
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      padding: MediaQuery
                                                                          .viewInsetsOf(
                                                                              context),
                                                                      child:
                                                                          ServiceRequestDetailsComponentWidget(),
                                                                    ),
                                                                  ),
                                                                );
                                                              },
                                                          ...
                                                          child: wrapWithModel(
                                                            ...
                                                            updateCallback: () =>
                                                                safeSetState(
                                                                    () {}),
                                                            child:
                                                                ServiceRequestItemComponentWidget(
                                                              requestType:
                                                                  'Apply for Auto Loan',
                                                              status:
                                                                  'New Request',
