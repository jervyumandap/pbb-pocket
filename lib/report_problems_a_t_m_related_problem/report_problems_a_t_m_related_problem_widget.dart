...
import 'report_problems_a_t_m_related_problem_model.dart';
export 'report_problems_a_t_m_related_problem_model.dart';

class ReportProblemsATMRelatedProblemWidget extends StatefulWidget {
  const ReportProblemsATMRelatedProblemWidget({super.key});

  static String routeName = 'reportProblemsATMRelatedProblem';
  static String routePath = '/reportProblemsATMRelatedProblem';

  @override
  State<ReportProblemsATMRelatedProblemWidget> createState() =>
      _ReportProblemsATMRelatedProblemWidgetState();
}

class _ReportProblemsATMRelatedProblemWidgetState
    extends State<ReportProblemsATMRelatedProblemWidget> {
  late ReportProblemsATMRelatedProblemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportProblemsATMRelatedProblemModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.isATMLocNotSelected = false;
      safeSetState(() {});
    });
                  ...
                  children: [
                                          ...
                                          children: [
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                if (_model.isATMLocNotSelected)
                                                  Text(
                                                    'ATM Location not selected.',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      if (_model.informationSelected == null) {
                                        ...
                                        _model.isATMLocNotSelected = true;
                                        safeSetState(() {});
                                      } else {
                    ...
                    wrapWithModel(
                      ...
                      child: CustomMobileAppBarWidget(
                        ...
                        titleLeftAlign: 'ATM Related Problem',
