...
import '/index.dart';
import 'report_problems_a_t_m_related_problem_widget.dart'
    show ReportProblemsATMRelatedProblemWidget;
import 'package:flutter/material.dart';

class ReportProblemsATMRelatedProblemModel
    extends FlutterFlowModel<ReportProblemsATMRelatedProblemWidget> {
  ///  Local state fields for this page.

  ReportATMRelatedSelectedStruct? informationSelected;
  void updateInformationSelectedStruct(
      Function(ReportATMRelatedSelectedStruct) updateFn) {
    updateFn(informationSelected ??= ReportATMRelatedSelectedStruct());
  }
