...
import 'report_problems_deposit_problem_model.dart';
export 'report_problems_deposit_problem_model.dart';

class ReportProblemsDepositProblemWidget extends StatefulWidget {
  const ReportProblemsDepositProblemWidget({super.key});

  static String routeName = 'reportProblemsDepositProblem';
  static String routePath = '/reportProblemsDepositProblem';

  @override
  State<ReportProblemsDepositProblemWidget> createState() =>
      _ReportProblemsDepositProblemWidgetState();
}

class _ReportProblemsDepositProblemWidgetState
    extends State<ReportProblemsDepositProblemWidget> {
  late ReportProblemsDepositProblemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportProblemsDepositProblemModel());
                  ...
                  children: [
                    ...
                    wrapWithModel(
                      ...
                      child: CustomMobileAppBarWidget(
                        ...
                        titleLeftAlign: 'Deposit Problem',
