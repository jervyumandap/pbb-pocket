...
import '/index.dart';
import 'report_problems_deposit_problem_widget.dart'
    show ReportProblemsDepositProblemWidget;
import 'package:flutter/material.dart';

class ReportProblemsDepositProblemModel
    extends FlutterFlowModel<ReportProblemsDepositProblemWidget> {
  ///  Local state fields for this page.

  ReportDepositProblemSelectedStruct? informationSelected;
  void updateInformationSelectedStruct(
      Function(ReportDepositProblemSelectedStruct) updateFn) {
    updateFn(informationSelected ??= ReportDepositProblemSelectedStruct());
  }
