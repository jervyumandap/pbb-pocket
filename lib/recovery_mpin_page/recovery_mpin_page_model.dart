...
import '/index.dart';
import 'recovery_mpin_page_widget.dart' show RecoveryMpinPageWidget;
import 'package:flutter/material.dart';

class RecoveryMpinPageModel extends FlutterFlowModel<RecoveryMpinPageWidget> {
  ...
  DateTime? datePicked;
  // Stores action output result for [Backend Call - API (Retail Auth Mpin Recovery Initiate)] action in Validate-Button widget.
  ApiCallResponse? mpinRecoveryResponse;
