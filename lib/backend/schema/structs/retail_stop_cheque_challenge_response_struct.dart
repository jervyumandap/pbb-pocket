...
class RetailStopChequeChallengeResponseStruct extends BaseStruct {
  RetailStopChequeChallengeResponseStruct({
    String? challenge,
    String? expiresAt,
    int? expiresIn,
  ...
  static RetailStopChequeChallengeResponseStruct fromMap(
  ...
  static RetailStopChequeChallengeResponseStruct? maybeFromMap(dynamic data) =>
      data is Map
          ? RetailStopChequeChallengeResponseStruct.fromMap(
  ...
  static RetailStopChequeChallengeResponseStruct fromSerializableMap(
          Map<String, dynamic> data) =>
      RetailStopChequeChallengeResponseStruct(
  ...
  @override
  String toString() => 'RetailStopChequeChallengeResponseStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is RetailStopChequeChallengeResponseStruct &&
...
RetailStopChequeChallengeResponseStruct
    createRetailStopChequeChallengeResponseStruct({
  String? challenge,
  String? expiresAt,
  int? expiresIn,
  String? preferredMethod,
