...
class EffectiveStruct extends BaseStruct {
  EffectiveStruct({
    double? minAmount,
    double? maxAmount,
    double? dailyLimit,
  ...
  static EffectiveStruct fromMap(Map<String, dynamic> data) => EffectiveStruct(
  ...
  static EffectiveStruct? maybeFromMap(dynamic data) => data is Map
      ? EffectiveStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static EffectiveStruct fromSerializableMap(Map<String, dynamic> data) =>
      EffectiveStruct(
  ...
  @override
  String toString() => 'EffectiveStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is EffectiveStruct &&
...
EffectiveStruct createEffectiveStruct({
  double? minAmount,
  double? maxAmount,
  double? dailyLimit,
}) =>
