...
class SigningChallengeStruct extends BaseStruct {
  ...
  static SigningChallengeStruct fromMap(Map<String, dynamic> data) =>
      SigningChallengeStruct(
  ...
  static SigningChallengeStruct? maybeFromMap(dynamic data) => data is Map
      ? SigningChallengeStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static SigningChallengeStruct fromSerializableMap(
  ...
  @override
  String toString() => 'SigningChallengeStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is SigningChallengeStruct &&
...
SigningChallengeStruct createSigningChallengeStruct({
  String? challenge,
  String? expiresAt,
  int? expiresIn,
  String? preferredMethod,
