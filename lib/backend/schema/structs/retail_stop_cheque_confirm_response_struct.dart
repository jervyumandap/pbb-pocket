...
class RetailStopChequeConfirmResponseStruct extends BaseStruct {
  RetailStopChequeConfirmResponseStruct({
    String? id,
  ...
  static RetailStopChequeConfirmResponseStruct fromMap(
  ...
  static RetailStopChequeConfirmResponseStruct? maybeFromMap(dynamic data) =>
      data is Map
          ? RetailStopChequeConfirmResponseStruct.fromMap(
  ...
  static RetailStopChequeConfirmResponseStruct fromSerializableMap(
          Map<String, dynamic> data) =>
      RetailStopChequeConfirmResponseStruct(
        id: deserializeParam(
          data['id'],
  ...
  @override
  String toString() => 'RetailStopChequeConfirmResponseStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is RetailStopChequeConfirmResponseStruct &&
        id == other.id &&
...
RetailStopChequeConfirmResponseStruct
    createRetailStopChequeConfirmResponseStruct({
  String? id,
  String? referenceNumber,
  String? accountNumber,
  String? chequeNumber,
