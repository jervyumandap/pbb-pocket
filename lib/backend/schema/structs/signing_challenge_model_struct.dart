...
class SigningChallengeModelStruct extends BaseStruct {
  ...
  static SigningChallengeModelStruct fromMap(Map<String, dynamic> data) =>
      SigningChallengeModelStruct(
  ...
  static SigningChallengeModelStruct? maybeFromMap(dynamic data) => data is Map
      ? SigningChallengeModelStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static SigningChallengeModelStruct fromSerializableMap(
  ...
  @override
  String toString() => 'SigningChallengeModelStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is SigningChallengeModelStruct &&
...
SigningChallengeModelStruct createSigningChallengeModelStruct({
  String? challenge,
  String? expiresAt,
  int? expiresIn,
  String? preferredMethod,
