...
class LoanTransactionsListModelStruct extends BaseStruct {
  LoanTransactionsListModelStruct({
  ...
  static LoanTransactionsListModelStruct fromMap(Map<String, dynamic> data) =>
      LoanTransactionsListModelStruct(
  ...
  static LoanTransactionsListModelStruct? maybeFromMap(dynamic data) => data
          is Map
      ? LoanTransactionsListModelStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static LoanTransactionsListModelStruct fromSerializableMap(
  ...
  @override
  String toString() => 'LoanTransactionsListModelStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is LoanTransactionsListModelStruct &&
...
LoanTransactionsListModelStruct createLoanTransactionsListModelStruct({
  String? transactionId,
  String? transactionDate,
  String? valueDate,
  double? amount,
