...
class CIFDetailsStruct extends BaseStruct {
  CIFDetailsStruct({
    String? cif,
    String? cIFStatus,
    String? customerName,
  ...
  static CIFDetailsStruct fromMap(Map<String, dynamic> data) =>
      CIFDetailsStruct(
  ...
  static CIFDetailsStruct? maybeFromMap(dynamic data) => data is Map
      ? CIFDetailsStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static CIFDetailsStruct fromSerializableMap(Map<String, dynamic> data) =>
      CIFDetailsStruct(
  ...
  @override
  String toString() => 'CIFDetailsStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is CIFDetailsStruct &&
        cif == other.cif &&
...
CIFDetailsStruct createCIFDetailsStruct({
  String? cif,
  String? cIFStatus,
  String? customerName,
  String? customerShortName,
