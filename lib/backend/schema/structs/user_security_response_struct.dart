...
class UserSecurityResponseStruct extends BaseStruct {
  UserSecurityResponseStruct({
    int? id,
    int? userId,
    String? mpinHash,
  ...
  static UserSecurityResponseStruct fromMap(Map<String, dynamic> data) =>
      UserSecurityResponseStruct(
  ...
  static UserSecurityResponseStruct? maybeFromMap(dynamic data) => data is Map
      ? UserSecurityResponseStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static UserSecurityResponseStruct fromSerializableMap(
  ...
  @override
  String toString() => 'UserSecurityResponseStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is UserSecurityResponseStruct &&
        id == other.id &&
        userId == other.userId &&
...
UserSecurityResponseStruct createUserSecurityResponseStruct({
  int? id,
  int? userId,
  String? mpinHash,
  bool? biometricEnabled,
