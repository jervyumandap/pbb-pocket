...
class SmsStruct extends BaseStruct {
  SmsStruct({
    bool? available,
    bool? enabled,
  ...
  static SmsStruct fromMap(Map<String, dynamic> data) => SmsStruct(
        available: data['available'] as bool?,
        enabled: data['enabled'] as bool?,
      );

  static SmsStruct? maybeFromMap(dynamic data) =>
      data is Map ? SmsStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static SmsStruct fromSerializableMap(Map<String, dynamic> data) => SmsStruct(
  ...
  @override
  String toString() => 'SmsStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is SmsStruct &&
