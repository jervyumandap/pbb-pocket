...
class MpinVerifyErrorStruct extends BaseStruct {
  MpinVerifyErrorStruct({
    int? status,
    String? title,
    String? detail,
    String? error,
  ...
  static MpinVerifyErrorStruct fromMap(Map<String, dynamic> data) =>
      MpinVerifyErrorStruct(
  ...
  static MpinVerifyErrorStruct? maybeFromMap(dynamic data) => data is Map
      ? MpinVerifyErrorStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static MpinVerifyErrorStruct fromSerializableMap(Map<String, dynamic> data) =>
      MpinVerifyErrorStruct(
  ...
  @override
  String toString() => 'MpinVerifyErrorStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is MpinVerifyErrorStruct &&
        status == other.status &&
        title == other.title &&
        detail == other.detail &&
        error == other.error &&
...
MpinVerifyErrorStruct createMpinVerifyErrorStruct({
  int? status,
  String? title,
  String? detail,
  String? error,
