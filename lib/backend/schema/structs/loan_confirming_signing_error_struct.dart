...
class LoanConfirmingSigningErrorStruct extends BaseStruct {
  LoanConfirmingSigningErrorStruct({
    int? status,
    String? title,
    String? detail,
    String? error,
  ...
  static LoanConfirmingSigningErrorStruct fromMap(Map<String, dynamic> data) =>
      LoanConfirmingSigningErrorStruct(
  ...
  static LoanConfirmingSigningErrorStruct? maybeFromMap(dynamic data) => data
          is Map
      ? LoanConfirmingSigningErrorStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static LoanConfirmingSigningErrorStruct fromSerializableMap(
  ...
  @override
  String toString() => 'LoanConfirmingSigningErrorStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is LoanConfirmingSigningErrorStruct &&
        status == other.status &&
        title == other.title &&
        detail == other.detail &&
        error == other.error &&
...
LoanConfirmingSigningErrorStruct createLoanConfirmingSigningErrorStruct({
  int? status,
  String? title,
  String? detail,
  String? error,
