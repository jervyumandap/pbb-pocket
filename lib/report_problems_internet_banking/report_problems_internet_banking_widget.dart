...
import 'report_problems_internet_banking_model.dart';
export 'report_problems_internet_banking_model.dart';

class ReportProblemsInternetBankingWidget extends StatefulWidget {
  const ReportProblemsInternetBankingWidget({super.key});

  static String routeName = 'reportProblemsInternetBanking';
  static String routePath = '/reportProblemsInternetBanking';

  @override
  State<ReportProblemsInternetBankingWidget> createState() =>
      _ReportProblemsInternetBankingWidgetState();
}

class _ReportProblemsInternetBankingWidgetState
    extends State<ReportProblemsInternetBankingWidget> {
  late ReportProblemsInternetBankingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportProblemsInternetBankingModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.isDeviceNotSelected = false;
      safeSetState(() {});
    });
                  ...
                  children: [
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      if (_model.informationSelected == null) {
                                        ...
                                        _model.isDeviceNotSelected = true;
                                        safeSetState(() {});
                                      } else {
                                              ...
                                              _model.apiResult1j3 =
                                                ...
                                                description:
                                                    functions.reportFormatText(
                                                        'Issue:${_model.informationSelected?.selectedIssue}\\nConcern:${_model.informationSelected?.selectedConcern}\\nError Message:${_model.textController1.text}\\nDevice:${_model.informationSelected?.selectedDevice}\\nAdditional Info: ${_model.additionalDetailsTextController.text}'),
                    ...
                    wrapWithModel(
                      ...
                      child: CustomMobileAppBarWidget(
                        ...
                        titleLeftAlign: 'Internet Banking Problem',
                    ...
                    wrapWithModel(
                      ...
                      child: CustomWebAppBarWidget(
                        pageTitle: 'Internet Banking Problem',
                        leftButtonAction: () async {},
