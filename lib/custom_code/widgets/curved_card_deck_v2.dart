...
class CurvedCardDeckV2 extends StatefulWidget {
  const CurvedCardDeckV2({
    super.key,
    required this.width,
  ...
  @override
  State<CurvedCardDeckV2> createState() => _CurvedCardDeckV2State();
}

class _CurvedCardDeckV2State extends State<CurvedCardDeckV2> {
  ...
  Widget _buildMobileLayout(
    ...
    final bool peek = widget.showPeek;
