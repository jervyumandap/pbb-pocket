    ...
    pw.MultiPage(
      ...
      build: (context) => [
                ...
                child: pw.SizedBox(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text('Loans and Discounts'),
                      pw.Text('350 Rizal Ave Ext.'),
                      pw.Text('8th Ave Brgy 109'),
                      pw.Text('Grace Park'),
                      pw.Text('Caloocan City'),
                      pw.Text('Phone:'),
                    ],
                  ),
                ),
        ...
        pw.Container(
          ...
          child: pw.Center(
            child: pw.Text(
              'Loan Statement from ${formatter.format(fromDate)} to ${formatter.format(toDate)}',
              style: pw.TextStyle(
                fontSize: 18,
                fontWeight: pw.FontWeight.bold,
          ...
          children: [
            pw.Expanded(
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text('Account Number: $loanAccountNumber'),
            ...
            pw.Expanded(
              child: pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  pw.Text('Account Category: $accountType'),
