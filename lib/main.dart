...
void main() async {
  ...
  await actions.initFirebaseMessagingCore();
  await actions.handleFreshInstall();
  await actions.makeStatusBarTransparent();
  await actions.readUsernameSecurely();
  await actions.readBiometricPreferenceSecurely();
  await actions.listenConnectivityChanges();
...
class _MyAppState extends State<MyApp> {
  ...
  List<String> getRouteStack() =>
      _router.routerDelegate.currentConfiguration.matches
          .map((e) => getRoute(e))
          .toList();
  late Stream<PBBPocketAuthUser> userStream;
  ...
  void initState() {
    ...
    userStream = pBBPocketAuthUserStream()
      ..listen((user) {
