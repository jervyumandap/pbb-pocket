...
import 'report_problems_fund_transfer_problem_model.dart';
export 'report_problems_fund_transfer_problem_model.dart';

class ReportProblemsFundTransferProblemWidget extends StatefulWidget {
  const ReportProblemsFundTransferProblemWidget({super.key});

  static String routeName = 'reportProblemsFundTransferProblem';
  static String routePath = '/reportProblemsFundTransferProblem';

  @override
  State<ReportProblemsFundTransferProblemWidget> createState() =>
      _ReportProblemsFundTransferProblemWidgetState();
}

class _ReportProblemsFundTransferProblemWidgetState
    extends State<ReportProblemsFundTransferProblemWidget> {
  late ReportProblemsFundTransferProblemModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => ReportProblemsFundTransferProblemModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await action_blocks.refreshSessionActionBlock(context);
      _model.isIssueNotSelected = false;
      _model.isConcernNotSelected = false;
      _model.isTransferTypeNotSelected = false;
      safeSetState(() {});
    });
                  ...
                  children: [
                                          ...
                                          children: [
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                if (_model.isConcernNotSelected)
                                                  Text(
                                                    'Concern not selected.',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                if (_model
                                                    .isTransferTypeNotSelected)
                                                  Text(
                                                    'Transfer Type not selected.',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      if (_model.informationSelected == null) {
                                        ...
                                        _model.isConcernNotSelected = true;
                                        _model.isTransferTypeNotSelected = true;
                                        safeSetState(() {});
                                      } else {
                                        if (_model.informationSelected
                                          ...
                                          if (_model.informationSelected
                                            ...
                                            if (_model.informationSelected
                                                    ?.selectedTransferType ==
                                                '') {
                                              _model.isTransferTypeNotSelected =
                                                  true;
                                              safeSetState(() {});
                                            } else {
                                              _model.isTransferTypeNotSelected =
                                              ...
                                              _model.apiResult1j3 =
                                                ...
                                                reportType: _model
                                                    ...
                                                    ?.reportType,
                                                description:
                                                    functions.reportFormatText(
                                                        'Issue:${_model.informationSelected?.selectedIssue}Concern:${_model.informationSelected?.selectedConcern}\\n\\nTransfer Type:${_model.informationSelected?.selectedTransferType}\\nAdditional Info: ${_model.additionalDetailsTextController.text}'),
                    ...
                    wrapWithModel(
                      ...
                      child: CustomMobileAppBarWidget(
                        ...
                        titleLeftAlign: 'Fund Transfer Problem',
                    ...
                    wrapWithModel(
                      ...
                      child: CustomWebAppBarWidget(
                        pageTitle: 'Fund Transfer Problem',
                        leftButtonAction: () async {},
