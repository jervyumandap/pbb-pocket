...
import 'pay_bills_overview_page_old_model.dart';
export 'pay_bills_overview_page_old_model.dart';

class PayBillsOverviewPageOldWidget extends StatefulWidget {
  const PayBillsOverviewPageOldWidget({super.key});

  static String routeName = 'PayBillsOverviewPageOld';
  static String routePath = '/payBillsOverviewPageOld';

  @override
  State<PayBillsOverviewPageOldWidget> createState() =>
      _PayBillsOverviewPageOldWidgetState();
}

class _PayBillsOverviewPageOldWidgetState
    extends State<PayBillsOverviewPageOldWidget> {
  late PayBillsOverviewPageOldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PayBillsOverviewPageOldModel());
            ...
            if (MediaQuery.sizeOf(context).width <= 800.0) {
                        ...
                        child: Row(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                wrapWithModel(
                                  model: _model.favoriteTileComponentModel1,
                                  updateCallback: () => safeSetState(() {}),
                                  child: FavoriteTileComponentWidget(
                                    id: 1,
                                    name: 'My Insurance',
                                    icon: Icon(
                                      Icons.security,
                                ...
                                wrapWithModel(
                                  model: _model.favoriteTileComponentModel2,
                                  updateCallback: () => safeSetState(() {}),
                                  child: FavoriteTileComponentWidget(
                                    id: 1,
                                    name: 'My Insurance',
                                ...
                                wrapWithModel(
                                  model: _model.favoriteTileComponentModel3,
                                  updateCallback: () => safeSetState(() {}),
                                  child: FavoriteTileComponentWidget(
                                    id: 1,
                                    name: 'My Insurance',
                                ...
                                wrapWithModel(
                                  model: _model.favoriteTileComponentModel4,
                                  updateCallback: () => safeSetState(() {}),
                                  child: FavoriteTileComponentWidget(
                                    id: 1,
                                    name: 'My Insurance',
                                ...
                                wrapWithModel(
                                  model: _model.favoriteTileComponentModel5,
                                  updateCallback: () => safeSetState(() {}),
                                  child: FavoriteTileComponentWidget(
                                    id: 1,
                                    name: 'My Insurance',
                                ...
                                wrapWithModel(
                                  model: _model.favoriteTileComponentModel6,
                                  updateCallback: () => safeSetState(() {}),
                                  child: FavoriteTileComponentWidget(
                                    id: 1,
                                    name: 'My Insurance',
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          future: _model.getBillerCategoriesQuery2(
                            uniqueQueryKey:
                                '${currentUserUid}_${'pbbpocket://pbbpocket.com${GoRouterState.of(context).uri.toString()}'}',
                            overrideCache: false,
                            requestFn: () =>
                                SupabaseGroup.getBillerCategoriesCall.call(
                            ...
                            return GridView(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      SelectBillerPageWidget.routeName,
                                  ...
                                  child: wrapWithModel(
                                    model: _model.favoriteTileComponentModel7,
                                    updateCallback: () => safeSetState(() {}),
                                    child: FavoriteTileComponentWidget(
                                      id: 0,
                                      name: '',
              ...
              return Row(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(40.0, 100.0, 0.0, 100.0),
                    child: Container(
                      width: 500.0,
                      decoration: BoxDecoration(
                              ...
                              Container(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    } else if (_model.paymentBillState ==
                                        'ConfirmationOfPayment') {
                                      return Container(
                                        decoration: BoxDecoration(),
                                        child: wrapWithModel(
