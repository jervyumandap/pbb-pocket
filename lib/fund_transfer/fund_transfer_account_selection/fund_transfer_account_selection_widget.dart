...
import 'fund_transfer_account_selection_model.dart';
export 'fund_transfer_account_selection_model.dart';

class FundTransferAccountSelectionWidget extends StatefulWidget {
  const FundTransferAccountSelectionWidget({
    super.key,
  ...
  @override
  State<FundTransferAccountSelectionWidget> createState() =>
      _FundTransferAccountSelectionWidgetState();
}

class _FundTransferAccountSelectionWidgetState
    extends State<FundTransferAccountSelectionWidget>
    with TickerProviderStateMixin {
  late FundTransferAccountSelectionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FundTransferAccountSelectionModel());
                            ...
                            Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Semantics(
                                        label:
                                            'fund_transfer_select_account_title_text',
                                        child: Text(
                                          'Select Account',
                                      ...
                                      Semantics(
                                        label:
                                            'fund_transfer_select_account_close_button',
                                        child: InkWell(
                                ...
                                Align(
                                  ...
                                  child: Semantics(
                                    label:
                                        'fund_transfer_select_account_description_text',
                                    child: Text(
                                  ...
                                  children: [
                                    Builder(
                                      builder: (context) {
                                        ...
                                        return Semantics(
                                          label:
                                              'fund_transfer_select_account_list',
                                          child: ListView.separated(
                                            ...
                                            itemBuilder:
                                              ...
                                              return Semantics(
                                                label:
                                                    'fund_transfer_select_account_item_button',
                                                child: InkWell(
                                                  splashColor:
                                                      Colors.transparent,
                                                  focusColor:
                                                  ...
                                                  child: AccountCardWidget(
                                                    key: Key(
                                                        'Key5o7_${accountsIndex}_of_${accounts.length}'),
                          ...
                          return ListView.separated(
                            ...
                            itemBuilder: (context, accountsIndex) {
                              ...
                              return InkWell(
                                ...
                                child: AccountCardWidget(
                                  key: Key(
                                      'Keyd6f_${accountsIndex}_of_${accounts.length}'),
