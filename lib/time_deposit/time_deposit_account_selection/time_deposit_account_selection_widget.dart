...
import 'time_deposit_account_selection_model.dart';
export 'time_deposit_account_selection_model.dart';

class TimeDepositAccountSelectionWidget extends StatefulWidget {
  const TimeDepositAccountSelectionWidget({
    super.key,
  ...
  State<TimeDepositAccountSelectionWidget> createState() =>
      _TimeDepositAccountSelectionWidgetState();
}

class _TimeDepositAccountSelectionWidgetState
    extends State<TimeDepositAccountSelectionWidget>
    with TickerProviderStateMixin {
  late TimeDepositAccountSelectionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimeDepositAccountSelectionModel());
                                          ...
                                          itemBuilder:
                                            ...
                                            return InkWell(
                                              ...
                                              child: AccountCardWidget(
                                                key: Key(
                                                    'Keywkh_${accountsIndex}_of_${accounts.length}'),
                          ...
                          return ListView.separated(
                            ...
                            itemBuilder: (context, accountsIndex) {
                              ...
                              return InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  FFAppState().selectedAccount = accountsItem;
                                  safeSetState(() {});
                                  Navigator.pop(context);
                                },
                                child: AccountCardWidget(
                                  key: Key(
                                      'Key380_${accountsIndex}_of_${accounts.length}'),
