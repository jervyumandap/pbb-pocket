...
import 'recovery_password_page_model.dart';
export 'recovery_password_page_model.dart';

class RecoveryPasswordPageWidget extends StatefulWidget {
  const RecoveryPasswordPageWidget({
    super.key,
  ...
  static String routeName = 'RecoveryPasswordPage';
  static String routePath = '/recoveryPasswordPage';

  @override
  State<RecoveryPasswordPageWidget> createState() =>
      _RecoveryPasswordPageWidgetState();
}

class _RecoveryPasswordPageWidgetState extends State<RecoveryPasswordPageWidget>
    with TickerProviderStateMixin {
  late RecoveryPasswordPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecoveryPasswordPageModel());

    _model.usernameTextFieldTextController ??= TextEditingController();
    _model.usernameTextFieldFocusNode ??= FocusNode();

    _model.accountNumberTextFieldTextController ??= TextEditingController();
    _model.accountNumberTextFieldFocusNode ??= FocusNode();
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Flexible(
                                          child: Semantics(
                                            label: 'Sub_Header_Text',
                                            child: Text(
                                              'Enter your username, account number, email and birthdate to receive a verification code.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .titleSmall
                                                      .override(
                                                ...
                                                Expanded(
                                                  child: Semantics(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: TextFormField(
                                                        controller: _model
                                                            .accountNumberTextFieldTextController,
                                                        focusNode: _model
                                                            .accountNumberTextFieldFocusNode,
                                                        autofocus: false,
                                                        obscureText: false,
                                                        decoration:
                                                            InputDecoration(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed:
                                        ((_model.usernameTextFieldTextController
                                                                .text ==
                                                            '') ||
                                                    (_model.accountNumberTextFieldTextController
                                                                .text ==
                                                            '') ||
                                            ...
                                            ? null
                                            : () async {
                                                _model.passwordRecoveryResponse =
