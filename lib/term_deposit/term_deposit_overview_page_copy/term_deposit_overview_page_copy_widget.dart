...
import 'term_deposit_overview_page_copy_model.dart';
export 'term_deposit_overview_page_copy_model.dart';

class TermDepositOverviewPageCopyWidget extends StatefulWidget {
  const TermDepositOverviewPageCopyWidget({super.key});

  static String routeName = 'TermDepositOverviewPageCopy';
  static String routePath = '/termDepositOverviewPageCopy';

  @override
  State<TermDepositOverviewPageCopyWidget> createState() =>
      _TermDepositOverviewPageCopyWidgetState();
}

class _TermDepositOverviewPageCopyWidgetState
    extends State<TermDepositOverviewPageCopyWidget> {
  late TermDepositOverviewPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TermDepositOverviewPageCopyModel());
                              ...
                              child: Column(
                                ...
                                children: [
                                  MouseRegion(
                                    ...
                                    onEnter: ((event) async {
                                      safeSetState(() =>
                                          _model.mregNewDepositHovered = true);
                                    }),
                                    onExit: ((event) async {
                                      safeSetState(() =>
                                          _model.mregNewDepositHovered = false);
                                    }),
                                  ),
                                  Container(
                                    decoration: BoxDecoration(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          FFButtonWidget(
                                            onPressed: (_model.depositAccounts
                                                        .where((e) =>
                                                            _model
                                                                .textFieldAccountNumberTextController
                                                                .text ==
                                                            ...
                                                            itemBuilder: (context,
                                                              ...
                                                              return wrapWithModel(
                                                                ...
                                                                child:
                                                                  ...
                                                                  key: Key(
                                                                    'Keyjxu_${transactionsIndex.toString()}',
                                                                  ),
                                                                  description:
                                                                      transactionsItem
                                                                          .fullNarration,
                              ...
                              () {
                                if (MediaQuery.sizeOf(context).width <
                                  ...
                                  return valueOrDefault<double>(
                                    FFAppState().isDrawerOpen ? 270.0 : 80.0,
                                    80.0,
                                  );
                                } else {
                                  return valueOrDefault<double>(
                                        ...
                                        children: [
                                          ...
                                          FFButtonWidget(
                                            onPressed: () async {
                                              ...
                                              _model.listTransactions = _model
                                                      ...
                                                      itemBuilder: (context,
                                                        ...
                                                        return wrapWithModel(
                                                          ...
                                                          child:
                                                              DepositTransactionsHistoryComponentWidget(
                                                            key: Key(
                                                              'Key8t3_${webTransactionsIndex.toString()}',
                                                            ),
                                                            description:
                                                                valueOrDefault<
                                                                    String>(
