...
import '/index.dart';
import 'term_deposit_overview_page_widget.dart'
    show TermDepositOverviewPageWidget;
import 'package:flutter/material.dart';

class TermDepositOverviewPageModel
    extends FlutterFlowModel<TermDepositOverviewPageWidget> {
  ...
  // Stores action output result for [Action Block - getDepositAccounts] action in TermDepositOverviewPage widget.
  List<DepositAccountsStruct>? listDepositAccounts;
  // Stores action output result for [Action Block - getDepositDetails] action in TermDepositOverviewPage widget.
