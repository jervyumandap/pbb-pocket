...
import '/components/payment_channel_component/payment_channel_component_widget.dart';
...
import 'term_deposit_new_page_model.dart';
export 'term_deposit_new_page_model.dart';

class TermDepositNewPageWidget extends StatefulWidget {
  const TermDepositNewPageWidget({
    super.key,
    String? bankName,
    String? accountName,
  ...
  static String routeName = 'TermDepositNewPage';
  static String routePath = '/termDepositNewPage';

  @override
  State<TermDepositNewPageWidget> createState() =>
      _TermDepositNewPageWidgetState();
}

class _TermDepositNewPageWidgetState extends State<TermDepositNewPageWidget> {
  late TermDepositNewPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TermDepositNewPageModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await Future.wait([
        ...
        Future(() async {
          _model.accountsOutput = await action_blocks.getAccounts(context);
        }),
      ]);
      _model.isLoading = false;
      _model.transactionActionState = false;
      _model.maturityDate = getCurrentTimestamp;
      _model.maturityValue = 0.00;
    });

    _model.textFieldAmountTextController ??= TextEditingController();
    _model.textFieldAmountFocusNode ??= FocusNode();
    _model.textFieldAmountFocusNode!.addListener(() => safeSetState(() {}));
                                                                  ...
                                                                  AlignedTooltip(
                                                                    content:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        mesage: FFAppState().IsInstaPayChannelSelected
                                                          ...
                                                          children: [
                                                            ...
                                                            Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                // Will take out this field based on API structure.
                                                                wrapWithModel(
                                                                  model: _model
                                                        ...
                                                        Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            if (FFAppState()
                                                                .IsInstaPayChannelSelected)
                                                              Text(
                                                                'Per transaction limit via Instapay is ₱50,000',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodySmall
                                                                    .override(
