...
import 'custom_informational_dialog_model.dart';
export 'custom_informational_dialog_model.dart';

class CustomInformationalDialogWidget extends StatefulWidget {
  const CustomInformationalDialogWidget({
    super.key,
    this.title,
    String? message,
  ...
  @override
  State<CustomInformationalDialogWidget> createState() =>
      _CustomInformationalDialogWidgetState();
}

class _CustomInformationalDialogWidgetState
    extends State<CustomInformationalDialogWidget> {
  late CustomInformationalDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomInformationalDialogModel());
