...
import 'save_recipient_modal_copy_widget.dart'
    show SaveRecipientModalCopyWidget;
import 'package:flutter/material.dart';

class SaveRecipientModalCopyModel
    extends FlutterFlowModel<SaveRecipientModalCopyWidget> {
  ...
  // Stores action output result for [Backend Call - API (Add Beneficiariy)] action in PrimaryButtonComponent widget.
