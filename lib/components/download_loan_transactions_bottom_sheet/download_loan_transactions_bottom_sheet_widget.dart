...
class DownloadLoanTransactionsBottomSheetWidget extends StatefulWidget {
  const DownloadLoanTransactionsBottomSheetWidget({
    super.key,
    String? title,
    String? message,
  ...
  @override
  State<DownloadLoanTransactionsBottomSheetWidget> createState() =>
      _DownloadLoanTransactionsBottomSheetWidgetState();
}

class _DownloadLoanTransactionsBottomSheetWidgetState
    extends State<DownloadLoanTransactionsBottomSheetWidget>
    with TickerProviderStateMixin {
  late DownloadLoanTransactionsBottomSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => DownloadLoanTransactionsBottomSheetModel());
