...
import 'quick_action_options_main_model.dart';
export 'quick_action_options_main_model.dart';

class QuickActionOptionsMainWidget extends StatefulWidget {
  const QuickActionOptionsMainWidget({super.key});

  @override
  State<QuickActionOptionsMainWidget> createState() =>
      _QuickActionOptionsMainWidgetState();
}

class _QuickActionOptionsMainWidgetState
    extends State<QuickActionOptionsMainWidget> with TickerProviderStateMixin {
  late QuickActionOptionsMainModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuickActionOptionsMainModel());
