...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    pBBPocketAuthUserSubject.add(
      PBBPocketAuthUser(loggedIn: false),
    );
  ...
  Future<PBBPocketAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Future<PBBPocketAuthUser?> _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = PBBPocketAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    pBBPocketAuthUserSubject.add(updatedUser);
  ...
  Future initialize() async {
    ...
    try {
      ...
      userData = _prefs.getString(_kUserDataKey) != null
          ? AuthenticatedUserStruct.fromSerializableMap(
